...
//import all classes in java io and net packages; and Scanner class of util package
import java.io.*;
import java.net.*;
import java.util.Scanner;

//client class to get acceptance decision and composite score
public class GradAcceptOneClient {
